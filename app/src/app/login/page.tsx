...
function LoginContent() {
  ...
  return (
    <div className="max-w-md mx-auto text-center py-16">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Sign in to PDF Summarizer</h1>
      <p className="text-gray-600 mb-8">
        Create a free account to start summarizing PDFs. No credit card required.
      </p>
